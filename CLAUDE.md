...
|---|---|---|---|---|
| 1 | 노력과 끈기 | `#F5E6C8` → `#E8C87A` | 황금빛 | 우공이산, 형설지공, 백절불굴, 작심삼일, 일취월장 |
...
- **[완료] ep01 우공이산** — 9씬 완성 (`images/ep01/scene1~9.webp`, `data/ep01.js`)
- **[다음] ep02 형설지공** — 다음 작업 대상 (Vol.1 · 노력과 끈기 · 황금빛 팔레트 유지)
- **[예정] ep03 ~ ep50** (Vol.1 잔여 3편 → Vol.2 → ... → Vol.10)
